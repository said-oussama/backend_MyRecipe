...
var MoralisWeb3 = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(MoralisWeb3, null, [{
                          ...
                          while (1) {
                            switch (_context10.prev = _context10.next) {
                              ...
                              case 3:
                                ...
                                if (options.disableTriggers !== true) _this.handleTriggers(response.data.result.triggers);
    ...
    key: "handleTriggers",
    value: function () {
      var _handleTriggers = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee8(_triggersObject) {
        return _regenerator.default.wrap(function (_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 2:
                if (_triggersObject['openUrl']) {
                  window.open(_triggersObject['openUrl'].url);
                }
